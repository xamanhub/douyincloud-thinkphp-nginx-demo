...
class Index extends BaseController
{
    ...
    public function getTest($data): Json
    {
        return self::getResponse('0', 'fail', $data);
        ...
        //创建Access Token
        $accessToken = AccessTokenBuilder::build(18823176, ACCESS_TOKEN_SHOP_ID);
